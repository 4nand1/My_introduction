...
const DEFAULTS = {
  hero: {
    name: "Anand", title: "Full-Stack Developer",
    ...
    tagline: "Strategy → Logic → Scalable Code.", location: "Mongolia",
  ...
  projects: [
    ...
    { id: "02", title: "AI Image Model", subtitle: "food.ingredient.detector", year: "2025", description: "Upload a food photo and AI instantly detects the ingredients.", tags: "Next.js, TypeScript, Google Gemini, HuggingFace, Tailwind", live: "https://ai-img-model.vercel.app", repo: "https://github.com/4nand1/AI_IMG_MODEL" },
    { id: "03", title: "NomNom", subtitle: "food.delivery.platform", year: "2025", description: "A fast food delivery platform with user accounts, browsable menus, and delivery zones.", tags: "TypeScript, Next.js, Tailwind", live: "https://food-delivery-zeta-six.vercel.app", repo: "https://github.com/4nand1/food-delivery" },
